...
export default function Layout({ children, title = '' }) {
  return <>
    <Head>
      <title>{'rbnu.nl' + (title && ' | ' + title)}</title>
      <meta charSet="utf-8"/>
...
const Footer = () => {
  ...
  return (
    <footer className="container">
      <p>&copy; {year} <a href="https://github.com/rubenuijtdewilligen/rbnu.github.io">Ruben Uijtdewilligen</a><br />Website design by <a href="https://github.com/lucko/lucko.github.io">lucko</a></p>
    </footer>
  )
}
